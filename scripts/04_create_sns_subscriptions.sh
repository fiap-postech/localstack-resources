...
aws --endpoint-url=http://localhost:4566 sns subscribe --profile=localstack --topic-arn arn:aws:sns:us-east-1:000000000000:local-purcharse-created-topic --protocol sqs --notification-endpoint arn:aws:sqs:us-east-1:000000000000:local-manufacture-purcharse-created-queue --attributes RawMessageDelivery=true
